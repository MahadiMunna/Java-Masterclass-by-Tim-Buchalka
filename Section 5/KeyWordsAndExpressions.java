public class KeyWordsAndExpressions{
    ...
    public static void main(String[] args){
        double kilometers = 100*1.609344; //100*1.609344 is an expression and kilometers = 100*1.609344 is also an expression. But this line with datatype and semicolon is called statement
        int highScore = 50;
        if (highScore>25){
